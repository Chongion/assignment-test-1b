...
describe("objects", () => {
  ...
  it.skip("insanely long names are invalid", () => {
    const person1 = {
      firstName: "Jaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaames",
      middleName: "Roger",
      lastName: "Smith",
    };
  ...
  it.skip("check invalid payment object", () => {
    const payment = {
      sum: 1.33, // Invalid. We only allow integers. This is a float.
    };
